...
class App:
    ...
    def route_change(self, e):
        try:
            ...
            elif self.page.route == "/consulta_corte_caja":
                from views.consulta_corte_caja import ConsultaCorteCajaView
                self.page.views.append(ConsultaCorteCajaView(self.navegar, self.page).build())
